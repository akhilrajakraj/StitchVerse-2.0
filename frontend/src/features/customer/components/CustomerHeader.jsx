    ...
    <header className="bg-white dark:bg-gray-900 shadow-sm border-b border-gray-100 dark:border-gray-800 sticky top-0 z-50 transition-colors duration-300">
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <Link to="/customer/dashboard" className="text-2xl font-bold text-blue-600 dark:text-blue-400" style={{fontFamily: 'Pacifico, cursive'}}>
            StitchVerse <span className="text-sm font-sans text-gray-500 dark:text-gray-400 ml-2">for Customer</span>
          </Link>
